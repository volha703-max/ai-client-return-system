...
- **Что делает:** Создаёт сайты, квизы, чат-боты, приложения Mini App, автоматические напоминания — всё без участия клиента
...
## Дизайн — единый стиль для всех страниц

Применяется к: `index.html`, `vizitka_kalkulyator.html`, `landing_kalkulyator.html`, `landing-cosmetolog.html`, `vizitka-cosmetolog.html`

Все страницы используют одну светлую кремовую тему. Тёмной темы нет — она была в ранних версиях, сейчас неактуальна.

## Дизайн — Косметолог (светлая тема, актуально)

Применяется к: всем файлам проекта
