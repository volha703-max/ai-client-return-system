...
## О продукте
AI-система для косметологов, которая автоматически возвращает клиентов на повторные процедуры через Telegram-бота. Целевая аудитория — частные косметологи и небольшие бьюти-студии с базой от 30 клиентов.
